...
public class Coordinates {
    private float x;
    private Float y; //Максимальное значение поля: 820, Поле не может быть null
}
...
*   Вернуть количество объектов, значение поля fuelConsumption которых равно заданному.
