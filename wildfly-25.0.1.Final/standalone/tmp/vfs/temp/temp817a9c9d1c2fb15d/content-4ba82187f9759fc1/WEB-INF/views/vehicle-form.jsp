        ...
        <form method="post" action="<c:url value='${vehicle.id == 0 ? "/vehicles/create" : "/vehicles/" += vehicle.id += "/update"}'/>">
            ...
            <div class="form-group">
                ...
                <div id="newCoords" class="hidden">
                    <label>X:</label>
                    <input type="number" step="0.01" name="newCoordX" value="${vehicle.coordinates != null ? vehicle.coordinates.x : ''}">
                    <label>Y (макс. 820):</label>
                    <input type="number" step="0.01" name="newCoordY" value="${vehicle.coordinates != null ? vehicle.coordinates.y : ''}" max="820" required>
                </div>
            </div>
